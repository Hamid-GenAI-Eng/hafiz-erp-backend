...
exports.restrictSupplierAndLedgerAlteration = exports.requireRole = exports.authenticateToken = void 0;
 ...
 */
const restrictSupplierAndLedgerAlteration = (req, res, next) => {
    if (!req.user) {
        res.status(401).json({ error: 'Unauthorized' });
        return;
    }
...
exports.restrictSupplierAndLedgerAlteration = restrictSupplierAndLedgerAlteration;
